...
class Contact extends Component {
  ...
  validate(firstname, lastname, telnum, email) {
      ...
      if(this.state.touched.telnum && !reg.test())
          errors.telnum = "Telephone number should include only numbers";

      if(this.state.touched.email && !email.split('').filter(x => x ==='@'.length !== 1))
          errors.email = "Invalid email : email should contain a @";
                    ...
                    <Form onSubmit={this.handleSubmit}>
                        <FormGroup row>
                            ...
                            <Col md={10}>
                              ...
                              valid={errors.firstname === ''}  invalid={errors.firstname !== ''} onBlur={this.handleBlur('firstname')} onChange={this.handleInputChange}/>
                        ...
                        <FormGroup row>
                            ...
                            <Col md={10}>
                              <Input type="tel" id="email" name="email" placeholder="Email" value={this.state.email} valid={errors.email === ''}
                        ...
                        <FormGroup row>
                            ...
                            <Col md={10}>
                              <Input type="textarea" id="message" name="message" placeholder="Your text here" rows="12" value={this.state.message} onChange={this.handleInputChange}/>
                            </Col>
                        </FormGroup>
                        <FormGroup row>
